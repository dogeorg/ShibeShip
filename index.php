...
<head>
  ...
  <link href="img/logo_dgg.png" rel="icon" />
...
<img src="img/fantoumi_doge.gif" style="max-width: 100px; position: absolute !important; z-index: 1069 !important; left: 10px; bottom: 15px" id="runningdoge" alt="Running Doge">
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
   <!-- Brand Logo -->
    <a href="index.php" class="brand-link">
      <img src="img/logo_dgg.png" alt="DogeGarden" style="max-width: 30px">
...
<?php if(!isset($_SESSION["shibe"])){ ?>
          <li class="nav-item" style="border-bottom: 1px solid #666666">
            <a href="#" class="nav-link btn-light" style="color: #333333">
              <i class="nav-icon far fa fa-plus nav-icon"></i>
              <p>
              Much Sell
...
<?php }else{ ?>
        ...
        <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="?d=listings" class="nav-link active">
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <?php
                      $i = 0;
                      $db = $pdo->query("SELECT * FROM banners where lang = '".$_SESSION["l"]."' and ".$filter." and active = 1 order by ord ASC");
                      while ($row = $db->fetch()) {
                  ?>
